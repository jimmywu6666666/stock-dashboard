...
def delete_history_records(
    ...
    try:
        service = HistoryService(db_manager)
        deleted = service.delete_history_records(record_ids, client_user_id=client_user_id)
        return DeleteHistoryResponse(deleted=deleted)
...
def get_history_detail(
    ...
    try:
        ...
        result = service.resolve_and_get_detail(record_id, client_user_id=client_user_id)
