...
class TaskInfo:
    ...
    def copy(self) -> 'TaskInfo':
        ...
        return TaskInfo(
            ...
            custom_news_items=copy.deepcopy(self.custom_news_items) if self.custom_news_items is not None else None,
...
class AnalysisTaskQueue:
    ...
    def submit_task(
        ...
        accepted, duplicates = self.submit_tasks_batch(
            ...
            custom_news_items=custom_news_items,
    ...
    def submit_tasks_batch(
        ...
        with self._data_lock:
            for stock_code in canonical_codes:
                ...
                task_custom_news_items = copy.deepcopy(custom_news_items) if custom_news_items is not None else None
                task_info = TaskInfo(
                    task_id=task_id,
                    trace_id=task_id,
                    ...
                    skills=task_skills,
                    report_language=report_language,
                    custom_news_items=task_custom_news_items,
                    client_user_id=client_user_id,
                )
